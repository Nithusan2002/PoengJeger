...
- `launch_waitlist`: e-postadresser med eksplisitt samtykke for én beskjed om pilot eller lansering. Tabellen har RLS uten klientpolicyer og kan bare skrives via den avgrensede `join-waitlist` Edge Function. E-postadresser er unike og normaliserte.
